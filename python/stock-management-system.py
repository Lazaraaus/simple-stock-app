...
if __name__ == '__main__':
	...
	print("add [quantity] [name] - adds quantity number of name to stock\n")
	print("delete [name] - deletes name from stock\n")
	print("receive [name] [quantity] - adds quantity number of items to existing stock\n")
	print("send [name] [quantity] - sends quanitity number of items out of stock\n")
